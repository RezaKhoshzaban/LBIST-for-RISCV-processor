...
vlib work_gate
#sh ${root_dir}/combist.sh

vlog -work work_gate ${root_dir}/thelbist/lfsr.v
vcom -work work_gate ${root_dir}/thelbist/phase_shifter.vhd
vcom -work work_gate ${root_dir}/thelbist/misr.vhd
vcom -work work_gate ${root_dir}/thelbist/MUX_2.vhd
vcom -work work_gate ${root_dir}/thelbist/BIST_controller1_2.vhd
vcom -work work_gate ${root_dir}/thelbist/MUX.vhd
...
vcom -mixedsvvh -work work_gate \
	${root_dir}/thelbist/top_lvl1_2.vhd

#vlog -sv -work work_gate -cover t -novopt -timescale "1 ns/ 1 ps"  -suppress 2577 -suppress 2583  \
vlog -sv -work work_gate -cover t -novopt -timescale "1 ns/ 1 ps"  \
